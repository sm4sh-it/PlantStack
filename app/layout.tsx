      ...
      <body className="min-h-screen bg-background font-sans antialiased flex flex-col">
        <ThemeProvider>
          ...
          <footer className="py-6 text-center text-sm text-surface-foreground/40 border-t border-black/5 dark:border-white/5 mt-auto flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4">
            <span>&copy; {new Date().getFullYear()} PlantStack v{pkg.version} | <a href="https://www.sm4sh.it" target="_blank" rel="noopener noreferrer" className="hover:text-brand transition-colors">sm4sh.it</a></span>
